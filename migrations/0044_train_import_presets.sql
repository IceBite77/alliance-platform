...
CREATE TABLE import_mapping_presets_new (
  ...
  dataset_type TEXT NOT NULL CHECK(dataset_type IN ('vs_history','desert_storm_history','shield_drop_history','train_history')),
  name TEXT NOT NULL,
...
UPDATE settings SET value='44',updated_at=CURRENT_TIMESTAMP WHERE key='schema_version';
