...
async function page(env:UiV2Env,context:UiV2Context,url:URL){
  ...
  return uiV2Html(renderUiV2Shell(context,{eyebrow:"Settings",title:"Ranks",description:"Set each rank’s name, colour and artwork. These values follow the player everywhere the rank is shown.",body,activePath:"/ui-v2/ranks",back:{href:"/ui-v2/settings",label:"Alliance Settings"}}));
}
