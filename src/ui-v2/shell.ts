...
function navigation(context:UiV2Context,activePath:string|undefined){
  ...
  return sections.map(section=>{
    ...
    return `<div class="menu-section" data-menu-section="${section.toLowerCase()}"><span class="menu-section-label">${section}</span>${items.map(item=>`<a href="${esc(item.href)}"${activePath===item.href?' class="current" aria-current="page"':""}>${esc(item.label)}</a>`).join("")}</div>`;
  }).join("");
}
...
.desktop-menu{display:none;position:absolute;z-index:20;right:0;top:calc(100% + 9px);width:min(580px,calc(100vw - 32px));padding:12px;border:1px solid var(--ui-line-strong);border-radius:13px;background:var(--ui-surface);box-shadow:0 22px 55px rgba(0,0,0,.45);text-align:left}.desktop-menu.open{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.menu-section{--menu-section-colour:var(--ui-accent)}.menu-section[data-menu-section="main"]{--menu-section-colour:#58c8ff}.menu-section[data-menu-section="management"]{--menu-section-colour:#b89aff}.menu-section[data-menu-section="events"]{--menu-section-colour:#f5c451}.menu-section[data-menu-section="analysis"]{--menu-section-colour:#51d88a}.menu-section[data-menu-section="data"]{--menu-section-colour:#57a5ff}.menu-section[data-menu-section="administration"]{--menu-section-colour:#ed8796}.desktop-menu .menu-section{min-width:0;padding:7px;border:1px solid color-mix(in srgb,var(--menu-section-colour) 28%,var(--ui-line));border-radius:10px;background:color-mix(in srgb,var(--menu-section-colour) 5%,var(--ui-surface-2))}.menu-section-label{display:block;margin-bottom:3px;padding:6px 9px;border-left:3px solid var(--menu-section-colour);border-radius:4px;background:color-mix(in srgb,var(--menu-section-colour) 10%,transparent);color:var(--menu-section-colour);font-size:.63rem;font-weight:950;letter-spacing:.1em;text-transform:uppercase}.desktop-menu a{display:block;padding:9px;border-radius:8px;color:var(--ui-navigation);font-size:.8rem;font-weight:780;text-decoration:none}.desktop-menu a:hover,.desktop-menu a.current{background:color-mix(in srgb,var(--menu-section-colour) 12%,var(--ui-surface-3));color:var(--menu-section-colour)}.menu-signout{grid-column:1/-1;margin-top:3px;padding-top:8px;border-top:1px solid var(--ui-line)}
...
.mobile-menu .menu-section{padding:8px;border:1px solid color-mix(in srgb,var(--menu-section-colour) 25%,var(--ui-line));border-radius:11px;background:color-mix(in srgb,var(--menu-section-colour) 5%,transparent)}.mobile-menu .menu-section+.menu-section{margin-top:10px}.mobile-menu .menu-section-label{padding:7px 10px}.mobile-menu a{display:block;padding:11px 12px;border-radius:9px;color:var(--ui-navigation);font-size:.9rem;font-weight:780;text-decoration:none}.mobile-menu a:hover,.mobile-menu a.current{background:color-mix(in srgb,var(--menu-section-colour) 12%,#18243a);color:var(--menu-section-colour)}.mobile-signout{margin-top:9px;padding-top:9px;border-top:1px solid var(--ui-line)}
...
.front-mobile-menu{display:none;width:min(100%,1500px);margin:0 auto;padding:8px 24px 18px;border-bottom:1px solid var(--ui-line);background:rgba(8,19,33,.96)}.front-mobile-menu a{display:block;padding:11px 12px;border-radius:9px;color:var(--ui-navigation);font-size:.86rem;font-weight:800;text-decoration:none}.front-mobile-menu a:hover,.front-mobile-menu a.current{background:color-mix(in srgb,var(--menu-section-colour) 12%,var(--ui-surface-3));color:var(--menu-section-colour)}.front-mobile-menu.open{display:none}
