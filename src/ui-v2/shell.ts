...
const styles=`
:root{color-scheme:dark;font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;--ui-bg:#090e18;--ui-surface:#151d2e;--ui-surface-2:#0e1626;--ui-surface-3:#111b2e;--ui-line:#2b3850;--ui-line-strong:#3a4b68;--ui-text:#eef3ff;--ui-muted:#90a0bb;--ui-soft:#b8c4d9;--ui-accent:#63b9e8;--ui-highlight:#aebddd;--ui-rank-highlight:#d7a83e;--ui-identity:#63b9e8;--ui-navigation:#aebddd;--ui-footer:#aebddd;--ui-danger:#ed8796;--ui-radius:20px;--ui-shadow:0 24px 70px rgba(0,0,0,.35)}
...
.alliance-copy span{display:block;margin-top:10px;color:var(--ui-identity);font-size:1rem;line-height:1.25;font-weight:800}
