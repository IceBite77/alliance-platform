...
export async function renderThemedError(request:Request,env:UiV2Env,status:number){
  ...
  const correctedHtml=html
    ...
    .replace('<a class="error-button secondary" href="/ui-v2/leadership">Leadership Console</a>',"")
