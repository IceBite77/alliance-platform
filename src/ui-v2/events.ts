...
function page(request:Request,context:UiV2Context,events:WeeklyEvent[]){
  ...
  return uiV2Html(renderUiV2Shell(context,{eyebrow:"Alliance Operations",title:"Weekly Events",description:"Set the regular event shown for each day of the week.",body,activePath:"/ui-v2/events",back:{href:"/ui-v2",label:"Leadership Console"}}));
}
