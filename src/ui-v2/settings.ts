...
async function discordPage(request:Request,env:UiV2Env,context:UiV2Context){
  ...
  let actions=current?`<div class="settings-actions"><a class="settings-button" href="/ui-v2/settings/discord-setup">Set up server and bot</a><a class="settings-button secondary" href="/ui-v2/settings/discord-notifications">Notification settings</a><a class="settings-button secondary" href="/ui-v2/settings/discord?action=change">Change server</a><a class="settings-button danger" href="/ui-v2/settings/discord?action=disconnect">Disconnect server</a></div>`:`<div class="settings-actions">${connect}</div>`;
