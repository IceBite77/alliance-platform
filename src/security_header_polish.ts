...
export default {
  async fetch(request:Request,env:Env,ctx:ExecutionContext):Promise<Response>{
    ...
    const user=who?`<div class="adminidentitynav"><div class="signedinidentity">${esc(who.display_name)} · R${who.rank}</div><div class="crumb"><a href="/leadership">← Leadership Console</a></div></div>`:`<div class="adminidentitynav"><div class="crumb"><a href="/leadership">← Leadership Console</a></div></div>`;
